...
const Company = ({ company }: CompanyProps) => {
  return (
    <div
      ...
      } hover:shadow-xl transition duration-300 ease-in-out bg-opacity-25 bg-cover !bg-gradient-to-r from-transparent to-transparent hover:!bg-[url("../../public/blood-israeli-flag.png")] bg-no-repeat`}
    >
      <img
        src={company.logo}
        alt={company.name}
